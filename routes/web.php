...
Route::middleware(['auth:sanctum','verified'])->group(function () {
    ...
    Route::get('/user/orders/{order_id}',UserOrdersDetailsComponent::class)->name('user.orderdetail');
    Route::get('/user/reviews/{order_item_id}',UserReviewComponent::class)->name('user.reviews');
...
Route::middleware(['auth:sanctum','verified','authadmin'])->group(function(){
    ...
    Route::get('/admin/produts',AdminProductComponent::class)->name('admin.products');
