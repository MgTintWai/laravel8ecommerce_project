                        ...
                        <form action="" class="form-horizontal" wire:submit.prevent = "addProduct" enctype="multipart/form-data" >
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4" wire:ignore>
                                    <textarea style="height: " type="text" id="short_description" placeholder="Short Description" class="form-control input-md" wire:model="short_description"></textarea>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    ...
                                    @if ($image)
                                    <img src="{{ $image->temporaryUrl() }}" style="width:50px;height:50px">
                                    @endif
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <input type="file" placeholder="Image" class="input-file" wire:model="images" multiple>
                                    @if ($images)
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <select class="form-control" wird:change="changeSubcategory" wire:model="scategory_id">
