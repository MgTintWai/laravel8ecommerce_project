            ...
            <div class="col-md-12">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        @endif
                        <form action="" class="form-horizontal" wire:submit.prevent = "updateSlide" enctype="multipart/form-data" >
                            ...
                            <div class="form-group">
                                <label for="" class="col-md-4 control-label">Slide Image</label>
                                <div class="col-md-4">
                                    ...
                                    @else
                                    <img src="{{ asset('assets/images/sliders') }}/{{ $image }}" style="width:120;">
                                    @endif
                                </div>
                            </div>
                            <div class="form-group">
