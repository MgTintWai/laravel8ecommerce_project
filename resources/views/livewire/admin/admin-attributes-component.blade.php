                                ...
                                @foreach ($pattributes as $pattribute)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="#" onclick="confirm('Are you sure,You want to delete this category?')|| event.stopImmediatePropagation()"  wire:click.prevent="deleteAttribute({{$pattribute->id}})"><i style="margin-left: 10px;" class="fa fa-times fa-2x text-danger "></i></a>
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
