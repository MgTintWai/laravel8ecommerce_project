	...
	<main id="main" class="main-site">
		<div class="container">
			...
			<div class=" main-content-area">
                ...
                {{-- For Product View --}}
					...
					<div class="summary">
						<div class="order-summary">
							...
							<p class="summary-info"><span class="title">Subototal with Discount</span><b class="index">${{ number_format($subtotalAfterDiscount,2) }}</b></p>
								...
								<div class="summary-item">
									<form wire:submit.prevent="applyCouponCode" >
										...
										@if (Session::has('coupon_message'))
											<div class="alert alert-danger" role="danger">{{ Session::get('coupon') }}</div>
										@endif
										<p class="row-in-form">
											<label for="coupon-code">Enter your coupon code:</label>
											<input type="text" name="coupon-code" id="have-code" wire:model="couponCode" >
										</p>
                ...
                {{-- For Save For Later --}}
				<div class="wrap-iten-in-cart">
					<h3 class="titl-box" style="border-bottom: 10px solid; padding-bottom:15px;">{{ Cart::instance('saveForLater')->count() }} item(s) Save For Later</h3>
