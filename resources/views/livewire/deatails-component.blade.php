					...
					<div class="wrap-product-detail">
						...
						<div class="detail-info">
                            ...
                            <div class="wrap-social">
                            	<a class="link-socail" href="#"><img src="{{ asset('assets/images/social-list.png')}}" alt="{{ $product->image }}"></a>
                            </div>
                            @if($product->sale_price > 0 && $sale->sale_date > Carbon\Carbon::now())
