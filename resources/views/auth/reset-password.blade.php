							...
							<div class="login-form form-item form-stl">
								...
								<form name="frm-login" method="POST" action="{{ route('password.update') }}">
									...
									<fieldset class="wrap-input">
										...
										<input type="email" id="password" name="email" placeholder="Type your email address" :value="{{$request->email}}" required autofocus>
									</fieldset>
                                    <fieldset class="wrap-input item-width-in-half left-item ">
										<label for="password_confirmation">Password *</label>
										<input type="password" id="password_confirmation" name="password" placeholder="Password" required autocomplete="new-password">
									</fieldset>
